...
extern const int BLOCK_COUNT = 256; // we split the "disk" into blocks (default = 256)
extern const int BLOCK_SIZE = 4096;  // default = 4K
extern const int NUFS_SIZE = 4096 * 256;   // default = 1MB
